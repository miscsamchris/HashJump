...
export default function BlockchainGamePage() {
  ...
  const getGameInfo = (scGame: SmartContractGame) => {
    ...
    return {
      ...
      description: `Blockchain game with ${scGame.levelsCount} levels. Prize pool: ${scGame.prizePool} HBAR. Cost: ${scGame.costOfPlay} HBAR.`,
      difficulty,
              ...
              <div className="mt-4 pt-4 border-t border-white/20">
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                  <div>
                    ...
                    <div className="font-semibold">{smartContractGame.prizePool} HBAR</div>
                  </div>
                  <div>
                    <div className="text-white/70">Cost to Play</div>
                    <div className="font-semibold">{smartContractGame.costOfPlay} HBAR</div>
                  </div>
                  <div>
                ...
                <div className="text-center text-white max-w-md">
                  {paymentStatus === 'pending' && (
                    <>
                      ...
                      <p className="text-gray-300 mb-6">
                        Pay {smartContractGame.costOfPlay} HBAR to start playing this blockchain game.
                      ...
                      <div className="bg-purple-900/30 border border-purple-600/30 rounded-lg p-4 mb-6">
                        <div className="flex justify-between items-center mb-2">
                          ...
                          <span className="font-semibold text-yellow-400">{smartContractGame.costOfPlay} HBAR</span>
                        </div>
                        <div className="flex justify-between items-center mb-2">
                          <span className="text-gray-400">Prize Pool:</span>
                          <span className="font-semibold text-green-400">{smartContractGame.prizePool} HBAR</span>
                        </div>
                    ...
                    <>
                      ...
                      <div className="bg-blue-900/30 border border-blue-600/30 rounded-lg p-4">
                        <div className="text-sm text-blue-300">
                          Sending {smartContractGame.costOfPlay} HBAR to {smartContractGame.owner.slice(0, 10)}...
                        </div>
                      </div>
                    </>
                  )}
        ...
        <Card className="mt-6 bg-black/40 border-purple-800/30">
          <CardContent className="p-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm text-gray-300">
              ...
              <div>• Complete all levels to earn HBAR tokens</div>
            </div>
          </CardContent>
        </Card>
      </div>
