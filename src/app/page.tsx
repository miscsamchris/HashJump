...
export default function GamingPlatform() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-black to-gray-800">
      ...
      <section className="py-20 px-4">
        <div className="container mx-auto text-center">
          <h1 className="text-5xl md:text-7xl font-bold text-white mb-6">
            Create. Play. <span className="text-gray-300">Win.</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/play">
              <Button 
                size="lg" 
                className="bg-gray-700 hover:bg-gray-600 text-lg px-8 py-4"
                disabled={!walletInfo}
              >
            ...
            <Link href="/create">
              <Button
                size="lg"
                variant="outline"
                className="border-gray-400 text-gray-400 hover:bg-gray-400 hover:text-white text-lg px-8 py-4"
                disabled={!walletInfo}
              >
      ...
      {/* Footer */}
      <footer className="bg-black/40 border-t border-gray-700/30 py-12 px-4">
