...
const LEVEL_SYMBOLS = {
  ...
  '>': { name: 'Enemy', description: 'Moving enemy', color: 'bg-gray-600', icon: '👻' },
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-black to-gray-800">
      ...
      <div className="container mx-auto px-4 pb-8">
        <h2 className="text-4xl font-bold text-white mb-8 text-center">
          Game <span className="text-gray-300">Creator</span>
        </h2>
        ...
        {!isEditingLevel ? (
          ...
          <div className="grid lg:grid-cols-3 gap-6">
            {/* Game Details */}
            <Card className="lg:col-span-2 bg-black/40 border-gray-700/30">
              <CardHeader>
              ...
              <CardContent className="space-y-6">
                <div className="grid md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      className="bg-black/20 border-gray-700/30 text-white"
                      disabled={!walletInfo}
                    />
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <Select 
                      ...
                      disabled={!walletInfo}
                    >
                      <SelectTrigger className="bg-black/20 border-gray-700/30 text-white">
                        <SelectValue />
                      </SelectTrigger>
                      <SelectContent className="bg-black border-gray-700/30">
                ...
                <div className="space-y-2">
                  ...
                  <Textarea
                    ...
                    className="bg-black/20 border-gray-700/30 text-white min-h-[100px]"
                    disabled={!walletInfo}
                  />
                </div>

                <div className="space-y-2">
                  <Label htmlFor="entryFee" className="text-white">Entry Fee (HBAR)</Label>
                  <Input
                    id="entryFee"
                    type="number"
                    value={game.entryFee}
              ...
              <CardContent className="space-y-4">
                <div className="space-y-3">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="text-yellow-400 font-semibold">{game.entryFee} HBAR</span>
                  </div>
                  <div className="flex justify-between">
                  ...
                  {grid.map((row, rowIndex) =>
                    row.map((cell, colIndex) => (
                      <button
                        ...
                        className={`w-4 h-4 border border-gray-600 hover:border-gray-400 transition-colors ${
                      ...
                      {Object.entries(presets).map(([gameKey, gameData]) =>
                        gameData.Levels.Levels.map((_, levelIndex) => (
                          <SelectItem 
                            ...
                            className="text-white hover:bg-gray-700/20"
                          >
              ...
              {game.levels.length === 0 ? (
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
                  {game.levels.map((level, index) => (
                    <Card key={level.id} className="bg-gray-800/20 border-gray-700/30">
